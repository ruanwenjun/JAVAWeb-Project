...
<script type="text/javascript">
	...
	function doDelete(){
		...
		if(selected.length != 0){
			...
			//未选择
			$.messager.alert('提示信息','请选择要删除的取派员','info');  
		}
	}
	...
	$(function(){
		...
		$('#grid').datagrid( {
			...
			pagination : true,
			toolbar : toolbar,
			url : "${pageContext.request.contextPath}/staffAction_pageQuery",      //表格查询的URL
			idField : 'id',              
			columns : columns,
...
<body class="easyui-layout" style="visibility:hidden;">
		...
		<div region="center" style="overflow:auto;padding:5px;" border="false">
			<form id="addStaffForm" method="post" action="${pageContext.request.contextPath }/staffAction_add">
				<table class="table-edit" width="80%" align="center">
					...
					<tr>
						<td>手机</td>
						<td><input type="text" name="telephone" class="easyui-validatebox" data-options="validType:'phone'" required="true"/>
							<!--保存取派员  -->
							<script type="text/javascript">
								//自定义手机校验
	...
	<div class="easyui-window" title="对收派员进行修改" id="editStaffWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
		<div region="north" style="height:31px;overflow:hidden;" split="false" border="false" >
			<div class="datagrid-toolbar">
				<a id="edit" icon="icon-edit"  class="easyui-linkbutton" plain="true" >保存修改</a>
			</div>
		</div>
